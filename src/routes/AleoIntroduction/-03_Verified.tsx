...
const Verified = () => {
  ...
  return (
    <>
      ...
      <p>
        Even though you don't know where the treasure is hidden, you can trust
        the game is not changing the hiding location based on your guess. Aleo
        verified the hiding with zero-knowledge proofs on chain.
      </p>

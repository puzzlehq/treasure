...
import { Route as win_route } from "@routes/FinishGame/Win/$gameId.js";

export const Route = createFileRoute("/FinishGame/Win/$gameId/01_Win")({
  component: function Component() {
    ...
    const [searchParams, setSearchParams] = useSearch({ from: win_route.to });

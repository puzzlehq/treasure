...
export const Route = createFileRoute("/AcceptGame/$gameId/01_SubmitWager")({
  component: function Component() {
    ...
    const [searchParams, setSearchParams] = useSearch({ from: Route.id });

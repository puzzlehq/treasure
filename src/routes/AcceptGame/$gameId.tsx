import SubmitWager from "./$gameId/01_SubmitWager";
import AcceptGamePage from "./$gameId/02_AcceptGame";
import Confirmed from "./$gameId/03_Confirmed";
...
export const Route = createFileRoute("/AcceptGame/$gameId")({

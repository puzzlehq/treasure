...
import { Route as game_info_route } from "@routes/GameIntroduction/index.js";
import { Route as aleo_info_route } from "@routes/AleoIntroduction/index.js";
    ...
    <section className="flex grow flex-col rounded-b-[10px] rounded-tr-[10px] border-2 border-solid border-bg2 bg-bg1 pb-6">
      ...
      <div className="flex flex-col px-5 pt-2 gap-4">
        <Button
          ...
          variant="gray"
          size="md"
          onClick={() => navigate({ to: game_info_route.to })}
        >
          How the Game Works
        </Button>
        <Button
          ...
          variant="gray"
          size="md"
          onClick={() => navigate({ to: aleo_info_route.to })}
        >
          Gaming on Aleo
        </Button>
      </div>

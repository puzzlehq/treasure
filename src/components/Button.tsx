...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        primary:
          "bg-primary disabled:opacity-40 font-header text-black drop-shadow-lg",
        secondary:
          "bg-bg1 border-bg2 border-[5px] disabled:opacity-40 drop-shadow-lg",
        tertiary:
          "bg-primary-light disabled:opacity-40 font-header text-black drop-shadow-",
